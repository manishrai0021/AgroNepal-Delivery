...
const RegisterAsCompany = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(data.get("phone").length < 9){
  return  alert("phone must be greater than 9 ")
    ...
    console.log(formData);
      ...
      await axios
        ...
        .then((res) => {
          ...
          if(res.data.status == 400)  alert(res.data.message)
          if(res.data.status === 500)  alert(res.data.messsage)
        //   alert(res.data.msg);
