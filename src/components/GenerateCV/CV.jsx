          ...
          <div>
            ...
            <div className=" py-2 bg-white rounded-b-lg dark:bg-gray-800">
              ...
              <textarea
                ...
                onChange={(e) => handleChange(e)}
                rows="4"
                className="block w-full px-0 text-sm text-gray-800 bg-white border-0 border-b-2 border-gray-300  dark:bg-gray-800 focus:ring-0 dark:text-black dark:placeholder-gray-400"
