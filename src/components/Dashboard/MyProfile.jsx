  ...
  return (
    <div>
      <div className="shadow-2xl">
        <div className="max-w-100 p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                onChange={(e) => {
                  ...
                  setDummy((prevDummy) => ({
                    ...prevDummy,
                    companyName: value.trim() === "" ? null : value.trim(),
                  }));
                }}
                value={dummy.companyName || ""}
              />
              <label
            ...
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                onChange={(e) => {
                  ...
                  setDummy((prevDummy) => ({
                    ...prevDummy,
                    address: value.trim() === "" ? null : value.trim(),
                  }));
                }}
                value={dummy.address || ""}
              />
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setDummy((prevDummy) => ({
                      ...prevDummy,
                      industry: value.trim() === "" ? null : value.trim(),
                    }));
                  }}
                  value={dummy.industry || ""}
                />
                <label
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setDummy((prevDummy) => ({
                      ...prevDummy,
                      website: value.trim() === "" ? null : value.trim(),
                    }));
                  }}
                  value={dummy.website || ""}
                />
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setDummy((prevDummy) => ({
                      ...prevDummy,
                      companySize: value.trim() === "" ? null : value.trim(),
                    }));
                  }}
                  value={dummy.companySize || ""}
                />
                <label
