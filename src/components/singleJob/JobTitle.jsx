...
const JobTitle = () => {
  ...
  const bookMark = async () => {
    ...
    if (res.data.status == 200) {
      ...
      document.getElementById("bookmarkId").innerHTML = "Bookmarked";
    }
  };
  return (
    <div className=" pt-6">
        ...
        <div>
          <div className="flex flex-wrap justify-between">
            <div className="flex flex-wrap">
              ...
              <span className="text-[23px] text-gray-400">
                @{job.companyName}
              </span>
            </div>
            <div>
          ...
          {login && (
            <div className="flex flex-wrap gap-8 pt-6">
              ...
              {isBookmark ? (
                ...
                >
                  <p id="bookmarkId" className="pl-2">
                    Bookmarked
                  </p>
                </button>
              ) : (
      ...
      <div className="flex flex-wrap gap-4 pt-5">
        ...
        <div className="xs:w-full sm:w-full md:w-[350px]">
          <div className="pt-6">
            <div className=" p-10 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
              <h3>Company Info</h3>
              <div className="grid gap-3 pt-5 overflow-x-auto">
      ...
      {localStorage.getItem("token") && (
        <div className="flex flex-col">
          <textarea
            ...
            style={{ width: "1000px", height: "50px", backgroundColor: "#ccc" }}
            onChange={(e) => setCommentMessage(e.target.value)}
          ></textarea>
          <button
            className="bg-blue-500 w-24 mt-4 mb-6 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
      ...
      <div style={{ display: "flex" }}>
        {reviews.map((review) => {
          return (
            <div key={review._id} className="pt-6 mb-6">
              <div className=" p-10 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
                <div style={{ display: "flex" }}>
                  {(() => {
                    const stars = [];
      ...
      <div style={{ display: "flex" }}>
        {similarJobs?.slice(0,2).map((job) => {
          ...
          return (
            <div
              key={job._id}
              class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-10 mb-5"
            >
              <div class="p-5">
                <a href="#">
